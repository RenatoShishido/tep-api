...
const monitoring = new Monitoring()
                    ...
                    .setMonitor(monitor)
                    .setPlace("Library")
                    .setStartTime(new Date('December 18, 1995 03:24:00'))
                    .setEndTime(new Date('December 18, 1995 05:24:00'))
                    .setCheckMonitoring(new CheckMonitoring(new Date('December 18, 1995 03:24:00'), new Date('December 18, 1995 03:24:00')))
